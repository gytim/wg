Общее задание: <https://github.com/gytim/wg/blob/master/task.txt>
Сделано за выходные. Если код некрасивый или там ошибки, буду не против критики. почта: ahrimana @ rambler.ru
